...
@giant = @megan.items.create!(name: 'Giant', description: "I'm a Giant!", price: 50, image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTaLM_vbg2Rh-mZ-B4t-RSU9AmSfEEq_SN9xPP_qrA2I6Ftq_D9Qw', active: true, inventory: 3 )
@hippo = @brian.items.create!(name: 'Hippo', description: "I'm a Hippo!", price: 50, image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTaLM_vbg2Rh-mZ-B4t-RSU9AmSfEEq_SN9xPP_qrA2I6Ftq_D9Qw', active: true, inventory: 3 )
@user_1 = User.create!(name: "Santi", user_name: "user_12345_email@emailplace.com", password: "test", role: 0, address: "123 Donut St", city: "Denver", state: "CO", zip: 22222)
...
@merchant_employee = User.create!(user_name: "nathan_2222@gmail.com", password: "password123", role: 0, name: "Nathan_2", address: "888 Market St", city: "Cheyenne", state: "WY", zip: 80012, merchant_id: @megan.id )
...
@will = User.create!(user_name: "wthomson", password: "123", role:1,  password_confirmation: "123", name: "Will Thompson", address: "123 Main St", city: "Longmont", state: "Colorado", zip: 80501)
