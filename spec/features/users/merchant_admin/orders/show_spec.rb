...
#
# RSpec.describe "Merchant admin order sho" do
...
#       end
#
#       describe "If the user's desired quantity is equal to or less than my current inventory quantity for that item And I have not already fulfilled that item" do
...
#             click_on "Fulfill Odrer"
#             expect(current_path).to eq(merchant_admins_order_path(@order_1.id))
#             expect(page).to have_content("You have fulfilled the order")
#             expect(@ogre.inventory).to eq(2)
#
#           end
#
