...
RSpec.describe "Merchant (Merchant_admin role: 1) Can Deactivate an active item" do
  describe "As a merchant" do
    ...
    it "when i visit my items page I see a link to deactivate items that are active" do
    ...
    it "When I click on 'Deactivate' I am returned to the items page where I see a flash message indicating the item is no longer for sale and I see the item is now inactive" do
